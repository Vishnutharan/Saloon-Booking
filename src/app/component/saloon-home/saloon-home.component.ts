...
export class SaloonHomeComponent implements OnInit {
  ...
  services: Service[] = [
    ...
    },
    {
      ...
      name: 'Hair Coloring',
      description:
        'Professional hair coloring services including highlights, balayage, and full color treatments.',
      price: '$85+',
  ...
  testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'Great atmosphere and amazing service. My go-to place for haircuts and styling!',
    ...
    },
    {
      ...
      rating: 4,
      comment:
        'The facial treatment was incredibly relaxing and my skin looks rejuvenated. Will definitely return!',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'Professional service and stunning results. The staff really knows what they are doing.',
  ...
  hairPricing: PricingItem[] = [
    {
      ...
      price: '$85',
      description:
        'Includes consultation, shampoo, conditioning, cut, and blow-dry style.',
      features: [
        'Professional Consultation',
        'Luxury Wash & Condition',
        'Precision Cut',
        'Signature Blowout',
      ],
    },
    {
      ...
      price: '$250+',
      description:
        'Hand-painted highlights for a natural, sun-kissed look. Includes toner.',
      features: [
        'Custom Color Mix',
        'Expert Application',
        'Glossing Toner',
  ...
  spaPricing: PricingItem[] = [
    {
      ...
      price: '$120',
      description:
        'A customized facial to address your specific skin concerns, leaving you radiant.',
      features: [
        'Skin Analysis',
  ...
  nailPricing: PricingItem[] = [
    {
      ...
      price: '$55',
      description:
        'Indulge in a pampering manicure with exfoliation, massage, and perfect polish.',
      features: [
  ...
  blogPosts: BlogPost[] = [
    {
      ...
      excerpt:
        'Discover the hottest hairstyles and colors to rock this summer season, from beachy waves to bold pastels...',
      category: 'Trends',
      author: 'Admin',
    },
    {
      ...
      image: 'assets/saloon5.png',
      excerpt:
        'Unlock the secrets to radiant skin with our comprehensive guide to building the perfect daily skincare regimen...',
      category: 'Skincare',
      author: 'Jane Doe',
    },
  ];
  ...
  @ViewChild('nav-btn') navLinks!: ElementRef;
  ...
  filterGallery(category: string): void {
    ...
    if (category === 'all') {
      ...
      this.filteredGalleryImages = this.galleryImages.filter(
